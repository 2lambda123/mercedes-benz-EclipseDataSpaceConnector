...
/**
 * Extension for running PG SQL store implementation. It automatically creates a
 * test database and provided all the base data structure for a SQL store to run
 * such as {@link DataSourceRegistry}, {@link TransactionContext} and data
 * source name which is automatically generated
 */
public class PostgresqlStoreSetupExtension
  ...
  public int runQuery(String query) {
    return transactionContext.execute(
        () -> queryExecutor.execute(getConnection(), query));
  }
  ...
  public void beforeAll(ExtensionContext context) {
    ...
    jdbcUrlPrefix =
        format("jdbc:postgresql://%s:%s/", postgreSQLContainer.getHost(),
               postgreSQLContainer.getFirstMappedPort());
    postgres = new PostgresqlLocalInstance(
        postgreSQLContainer.getUsername(), postgreSQLContainer.getPassword(),
        jdbcUrlPrefix, postgreSQLContainer.getDatabaseName());
  ...
  public void beforeEach(ExtensionContext context) {
    ...
    var dataSource =
        new ConnectionFactoryDataSource(connectionFactory, jdbcUrl, properties);
  ...
  public boolean supportsParameter(ParameterContext parameterContext,
    ...
    return List
        .of(PostgresqlStoreSetupExtension.class, Connection.class,
            QueryExecutor.class, PostgresqlLocalInstance.class)
        .contains(type);
  }
