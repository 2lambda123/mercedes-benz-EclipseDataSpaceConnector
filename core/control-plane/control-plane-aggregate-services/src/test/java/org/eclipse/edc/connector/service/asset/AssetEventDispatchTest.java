...
public class AssetEventDispatchTest {
  ...
  @Test
  void shouldDispatchEventsOnAssetCreationAndDeletion(
      AssetService service, EventRouter eventRouter,
      DataAddressValidatorRegistry dataAddressValidatorRegistry) {
    dataAddressValidatorRegistry.registerSourceValidator(
        "type", a -> ValidationResult.success());
