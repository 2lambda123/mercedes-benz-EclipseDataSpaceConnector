...
public class UriUtils {
  /**
   * Compares two URIs to check if they are equal after ignoring the fragment
   * part.
   *
   * @param u1 The first URI to compare.
   * @param u2 The second URI to compare.
   * @return {@code true} if the URIs are equal after ignoring the fragment
   *     part, {@code false} otherwise.
   */
   ...
   * @return The string with the fragment part removed, if it exists, otherwise
   *     the original string.
   */
