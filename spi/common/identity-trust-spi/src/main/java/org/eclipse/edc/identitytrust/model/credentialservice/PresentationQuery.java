...
/**
 * Represents a query DTO that is sent to a CredentialService. Must be
 * serialized to JSON-LD.
 *
 * @see <a
 *     href="https://github.com/eclipse-tractusx/identity-trust/blob/main/specifications/M1/verifiable.presentation.protocol.md#411-query-for-presentations">IATP
 *     Specification</a>
 */
public class PresentationQuery {
  public static final String PRESENTATION_QUERY_SCOPE_PROPERTY =
      IATP_PREFIX + "scope";
  public static final String PRESENTATION_QUERY_DEFINITION_PROPERTY =
      IATP_PREFIX + "presentationDefinition";
  public static final String PRESENTATION_QUERY_TYPE_PROPERTY =
      IATP_PREFIX + "Query";
  ...
  public static final class Builder {
    ...
    private Builder() { query = new PresentationQuery(); }
    ...
    public PresentationQuery build() { return query; }
  }
}
