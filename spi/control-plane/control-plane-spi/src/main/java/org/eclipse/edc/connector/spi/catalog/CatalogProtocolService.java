...
/**
 * Mediates access to and modification of {@link Catalog}es on protocol messages
 * reception.
 */
public interface CatalogProtocolService {

  /**
   * Returns a catalog given a {@link CatalogRequestMessage} and a {@link
   * ClaimToken}
   *
   ...
   */
  @NotNull
  ServiceResult<Catalog> getCatalog(CatalogRequestMessage message,
   ...
   */
  @NotNull
  ServiceResult<Dataset> getDataset(String datasetId,
                                    TokenRepresentation tokenRepresentation);
}
