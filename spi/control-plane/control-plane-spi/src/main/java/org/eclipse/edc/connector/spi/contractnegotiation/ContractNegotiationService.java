...
public interface ContractNegotiationService {
  ...
  /**
   * Fetches the {@linkplain ContractAgreement} for a given {@linkplain
   * ContractNegotiation}, or null if either the negotiation does not exist, or
   * no agreement has yet been reached.
   *
   * @param negotiationId the id of contract negotiation
   * @return the contract agreement, null if the negotiation does not exist or
   ...
   * @return successful result if the contract negotiation is terminated
