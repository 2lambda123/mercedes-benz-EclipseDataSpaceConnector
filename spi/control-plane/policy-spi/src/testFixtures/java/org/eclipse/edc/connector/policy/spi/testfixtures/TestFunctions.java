...
package org.eclipse.edc.connector.policy.spi.testfixtures;
...
public class TestFunctions {
  ...
  public static PolicyDefinition
  createPolicy(String id, String target,
  ...
  public static List<PolicyDefinition> createPolicies(int count) {
    return IntStream.range(0, count)
        .mapToObj(i -> createPolicy("policyDef" + i))
  ...
  public static Policy.Builder createPolicyBuilder(String id) {
    ...
    var prohibition = createProhibitionBuilder(id).build();
  ...
  public static Action createAction() {
    return Action.Builder.newInstance()
