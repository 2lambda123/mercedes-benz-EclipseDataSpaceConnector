...
public class DspErrorResponse {
  ...
  public DspErrorResponse(String type) { this.type = type; }
  ...
  public Response unauthorized() {
    return internalBuild(Response.Status.UNAUTHORIZED,
                         List.of("Token validation failed."));
  }
  ...
  public Response notImplemented() {
    return internalBuild(Response.Status.NOT_IMPLEMENTED,
                         List.of("Currently not supported."));
  }

  public Response internalServerError() {
    return internalBuild(Response.Status.INTERNAL_SERVER_ERROR,
  ...
  private Response internalBuild(Response.Status code,
                                 List<String> baseMessages) {
    var builder = DspError.Builder.newInstance().type(type).code(
        Integer.toString(code.getStatusCode()));
