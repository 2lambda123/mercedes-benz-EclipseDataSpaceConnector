...
/**
 * Provides the endpoints for receiving messages regarding transfers, like
 * initiating, completing and terminating a transfer process.
 */
...
public class DspTransferProcessApiController {
  ...
  public DspTransferProcessApiController(
  ...
  /**
   * Retrieves an existing transfer process. This functionality is not yet
   * supported.
   *
  ...
  /**
   * Initiates a new transfer process that has been requested by the
   * counter-party.
   *
   * @param jsonObject the {@link TransferRequestMessage} in JSON-LD expanded
   *     form
  ...
  public Response
  initiateTransferProcess(JsonObject jsonObject,
                          @HeaderParam(AUTHORIZATION) String token) {
    var request =
        PostDspRequest.Builder
            .newInstance(TransferRequestMessage.class, TransferProcess.class)
            .message(jsonObject)
            .token(token)
  ...
  /**
   * Notifies the connector that a transfer process has been started by the
   * counter-part.
   *
   * @param id         the ID of the process
  ...
  public Response
  transferProcessStart(@PathParam("id") String id, JsonObject jsonObject,
                       @HeaderParam(AUTHORIZATION) String token) {
    var request =
        PostDspRequest.Builder
            .newInstance(TransferStartMessage.class, TransferProcess.class)
            .processId(id)
  ...
  /**
   * Notifies the connector that a transfer process has been completed by the
   * counter-part.
   *
   * @param id         the ID of the process
   * @param jsonObject the {@link TransferCompletionMessage} in JSON-LD expanded
   *     form
   * @param token      the authorization header
   * @return empty response or error.
   */
  ...
  public Response
  transferProcessCompletion(@PathParam("id") String id, JsonObject jsonObject,
                            @HeaderParam(AUTHORIZATION) String token) {
    var request =
        PostDspRequest.Builder
            .newInstance(TransferCompletionMessage.class, TransferProcess.class)
            .processId(id)
  ...
  /**
   * Notifies the connector that a transfer process has been terminated by the
   * counter-part.
   *
   * @param id         the ID of the process
   * @param jsonObject the {@link TransferTerminationMessage} in JSON-LD
   *     expanded form
   * @param token      the authorization header
   * @return empty response or error.
   */
  ...
  public Response
  transferProcessTermination(@PathParam("id") String id, JsonObject jsonObject,
                             @HeaderParam(AUTHORIZATION) String token) {
    var request =
        PostDspRequest.Builder
            .newInstance(TransferTerminationMessage.class,
  ...
  /**
   * Notifies the connector that a transfer process has been suspended by the
   * counter-part. This functionality is not yet supported.
   *
   * @param id the ID of the process
   */
  @POST
